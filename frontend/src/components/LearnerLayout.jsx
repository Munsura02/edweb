...
import { HiOutlineSquares2X2, HiOutlineBookOpen, HiOutlineMagnifyingGlass, HiOutlineTrophy, HiOutlineUser, HiOutlineArrowRightOnRectangle } from 'react-icons/hi2';
    ...
    <div className="min-h-screen flex bg-gray-50">
      <aside className="w-56 bg-gray-100 border-r border-gray-200 flex flex-col">
        <div className="p-4 border-b border-gray-200">
          <h1 className="font-semibold text-gray-800">EdWeb</h1>
        </div>
        <nav className="flex-1 p-3">
          <p className="text-xs font-medium text-gray-500 uppercase tracking-wider px-3 py-2">Learning</p>
          <NavLink
            to="/learner"
            end
            className={({ isActive }) =>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between gap-4">
          <Link to="/" className="text-sm text-purple-600 hover:text-purple-700 font-medium shrink-0">← Instructor</Link>
          <input
            type="search"
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-right">
              <p className="font-medium text-gray-800">Learner User</p>
              <p className="text-sm text-gray-500">Student</p>
            </div>
            <div className="w-10 h-10 rounded-full bg-indigo-700 flex items-center justify-center text-white font-medium">L</div>
          </div>
        </header>
